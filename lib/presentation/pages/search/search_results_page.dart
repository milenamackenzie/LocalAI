...
class _SearchResultsPageState extends State<SearchResultsPage> {
  ...
  List<Location> _getSearchResults() {
    // In real app, this would be API call based on query
    final results = [
      Location(id: '9', title: 'The Innovation Hub', category: 'Coworking Space', score: 0.94, imageUrl: null, isBookmarked: false),
      Location(id: '10', title: 'Creative Studio', category: 'Arts', score: 0.89, imageUrl: null, isBookmarked: false),
      Location(id: '11', title: 'Tech Library', category: 'Education', score: 0.91, imageUrl: null, isBookmarked: false),
      Location(id: '12', title: 'Urban Cafe', category: 'Food & Dining', score: 0.87, imageUrl: null, isBookmarked: false),
    ];
    return results;
  }
